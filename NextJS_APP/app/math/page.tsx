...
import MathEngine from '../../components/math/MathEngine';
      ...
      <header className="bg-black border-b border-[#1a1a1a] sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-[22px] font-light text-white tracking-[0.1px]">Math Engine</h1>
            <p className="text-[#6b6b6b] text-xs mt-0.5">Adaptive difficulty — grows with you</p>
          </div>
          <AuthButton />
        </div>
      </header>
